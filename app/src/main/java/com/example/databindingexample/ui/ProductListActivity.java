...
public class ProductListActivity extends AppCompatActivity {
    ...
    public void populateProducts(){
        ...
        productArrayList.add(new Product(3,"Blue Coffee Mug", "Blue Coffee Mug for drinking coffee. 100% ceramic.", R.drawable.blue_mug, 5.99, 3.5F));
        productArrayList.add(new Product(4,"Black Baseball Hat", "Black Baseball Hat made of 100% authentic baseball hat material.", R.drawable.black_hat, 20.99, 3.5F));
        productArrayList.add(new Product(5,"Orange Baseball Hat", "Orange Baseball Hat made of 100% authentic baseball hat material.", R.drawable.orange_hat,23.99,4.0F));
